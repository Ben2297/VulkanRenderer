...
void main() {
	...
	fragNormal = vec3(ubo.view * ubo.model * vec4(inNormal, 1.0));

	fragLightVector = vec3(ubo.view * (vec4(lighting.lightPosition, 1.0) - VCS_position));

	fragEyeVector = vec3(-VCS_position);
